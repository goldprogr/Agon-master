...
RESOURCES += src/qt/agon.qrc src/qt/agon_locale.qrc

TRANSLATIONS += src/qt/locale/agon_bg.ts \
                src/qt/locale/agon_de.ts \
                src/qt/locale/agon_en.ts \
                src/qt/locale/agon_es.ts \
                src/qt/locale/agon_fi.ts \
                src/qt/locale/agon_fr.ts \
                src/qt/locale/agon_it.ts \
                src/qt/locale/agon_ja.ts \
                src/qt/locale/agon_pl.ts \
                src/qt/locale/agon_pt.ts \
                src/qt/locale/agon_ru.ts \
                src/qt/locale/agon_sk.ts \
                src/qt/locale/agon_sv.ts \
                src/qt/locale/agon_vi.ts \
                src/qt/locale/agon_zh_CN.ts \
                src/qt/locale/agon_zh_TW.ts
