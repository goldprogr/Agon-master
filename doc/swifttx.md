...
This mechanism has been integrated into Bitcore-Node-Agon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Agon-Project/insight-api-agon#web-socket-api](https://github.com/Agon-Project/insight-api-agon#web-socket-api) 
* API: [https://github.com/Agon-Project/insight-api-agon#swifttx-transactions](https://github.com/Agon-Project/insight-api-agon#swifttx-transactions) 
...
By default, the Agon Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Agon Core daemon:
