...
In order to support loading of multiple wallets in agon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is agon.cpp.
...
Changes to agon.cpp
----------------------
agon.cpp is the entry point into agon-qt, and as such, will require some minor modifications to provide hooks for
