...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::AGN, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (agon.conf).");
            QMessageBox::warning(this, "Agon Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#5E84A6;}\n a, span { font-family: monospace; }\n span.addr {color:#5E84A6; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #5E84A6;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#5E84A6;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#5E84A6;}\n";
