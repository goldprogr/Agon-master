                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Agon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Agon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and agon: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAGN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Agon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Agon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Agon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Agon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Agon addresses"));
    ...
    openAction->setStatusTip(tr("Open a Agon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Agon Core help message to get a list with possible Agon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Agon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Agon network", "", count));
}
...
{
    QString strTitle = tr("Agon Core"); // default title
