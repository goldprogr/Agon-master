...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Agon features */
        {"agon", "masternode", &masternode, true, true, false},
        {"agon", "listmasternodes", &listmasternodes, true, true, false},
        {"agon", "getmasternodecount", &getmasternodecount, true, true, false},
        {"agon", "masternodeconnect", &masternodeconnect, true, true, false},
        {"agon", "masternodecurrent", &masternodecurrent, true, true, false},
        {"agon", "masternodedebug", &masternodedebug, true, true, false},
        {"agon", "startmasternode", &startmasternode, true, true, false},
        {"agon", "createmasternodekey", &createmasternodekey, true, true, false},
        {"agon", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"agon", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"agon", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"agon", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"agon", "getmasternodescores", &getmasternodescores, true, true, false},
        {"agon", "mnbudget", &mnbudget, true, true, false},
        {"agon", "preparebudget", &preparebudget, true, true, false},
        {"agon", "submitbudget", &submitbudget, true, true, false},
        {"agon", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"agon", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"agon", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"agon", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"agon", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"agon", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"agon", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"agon", "checkbudgets", &checkbudgets, true, true, false},
        {"agon", "mnsync", &mnsync, true, true, false},
        {"agon", "spork", &spork, true, true, false},
        {"agon", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"agon", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use agond, or the -server option to agon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> agon-cli " + methodname + " " + args + "\n";
}
