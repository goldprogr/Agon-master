Contributing to Agon Core
============================

The Agon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Agon Core project, and is not to be
confused with overall Agon Network Protocol consensus changes.

Whether a pull request is merged into Agon Core rests with the project merge
...
Patches that change Agon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Agon consensus, it must have been
...
The project leader is the release manager for each Agon Core release.
